    ...
    <>
      <Container fluid>
          ...
          <Row className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 col-xxl-10 mx-auto mt-5 mb-5 pt-5 pb-5">
            ...
            >
              ...
              <p className="hometext pt-1 pb-1">
                Over 13 million businesses rely on News Reader to create and
        ...
        <Row className="mx-auto text-center mt-5 pt-5 mb-3">
          <h1 className="fontsize">Do it all with News Reader</h1>
        ...
        <Row className="bg-light mt-3 pb-5">
          <Col className="col-12 col-sm-12 col-md-7 col-lg-6 col-xl-5 col-xxl-5 mt-5 mb-1 text-center mx-auto">
            <h1 className="pt-1 pb-1">Grow with News Reader</h1>
        ...
        <Row className="mt-5 mb-5 mx-auto">
          ...
          >
            <Homekepp
              ...
              text="You can connect all your tools to News Reader and unlock even more features."
              link="Learn more"
            />
          </Col>
          <Col
          ...
          >
            <Homekepp
              ...
              text="Take your marketing to the next level when you work with a News Reader partner."
        ...
        <Row className="mt-5 mb-5 mx-auto">
          ...
          >
            ...
            <p className="fs-5 mb-3">
              "Since using News Reader, I feel so much more confident in
