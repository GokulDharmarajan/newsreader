    ...
    <Container fluid className="">
      ...
      >
        <Row>
          ...
          >
            <Firstbox
              name="Premium"
              name1="Advanced features for pros who need more customization. "
              name2="Starts at"
              name3="$"
              name4="23,000"
              name5="/month*"
              ...
              name12="Unlimited Seats & Role-Based Access"
      ...
      >
        <Col className=' "d-flex justify-content-center"'>
          ...
          <Col className="text-center mx-auto ms-5">
            <Acc />
          </Col>
        </Col>
      </Col>
